...
public class LearnJava1 {
  ...
  //      BigDecimal tenCents = new BigDecimal("0.1");
        ...
        */
        ...
        System.out.println(s++); // i = 1, prints 0 (post-increment)
        System.out.println(++s); // i = 2, prints 2 (pre-increment)
        System.out.println(s--); // i = 1, prints 2 (post-decrement)
        System.out.println(--s); // i = 0, prints 0 (pre-decrement)
